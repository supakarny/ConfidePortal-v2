...
export default function ServiceWorkloadPage() {
        ...
        >
          ...
          {dayCap && dayCap.engineers.length > 0 && (
            <div className={`text-[10px] px-1.5 py-0.5 rounded border font-semibold ${dayCap.color}`}>
              {dayCap.level.toUpperCase()} ({dayCap.engineers.length} Tech)
            </div>
          )}
        </div>
      )
  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div>
        ...
        <h1 className="text-headline-xl text-on-surface mt-1">Workload Calendar</h1>
        <p className="text-body-md text-secondary mt-1">
          Review service technicians' deployment schedules, dispatcher workloads, and load indicators.
        </p>
      </div>
            ...
            <div className="flex-1 mt-4 space-y-4">
              {activeDayCap && activeDayCap.engineers.length > 0 ? (
                <>
                  ...
                  <div>
                    <p className="text-label-sm text-secondary uppercase tracking-wider mb-2 font-bold">Assigned Technicians</p>
                ...
                <div className="flex flex-col items-center justify-center py-12 text-center text-secondary">
                  ...
                  <p className="text-label-sm mt-0.5">No critical technician deployment scheduled.</p>
                </div>
              )}
            </div>
